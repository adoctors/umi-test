                      ...
                      >
                        {
                          ObjectNonEmpty(rowSelection)&&(
                            <div className={classNames(fixedHeight?styles.rcrColHeight:styles.rcrCol,)}>
                              <Checkbox key={setKey(item.dataIndex)} onClick={e=>this.checkedRow(e,item,index)} checked={item.checked} />
                            </div>
                          )
                        }
                        ...
                        {columns.map((column,i)=>
                          ...
                          >
                            ...
                            (showTitle?<span title={item[column.dataIndex]} key={setKey(item[column.dataIndex])}>{item[column.dataIndex]}</span>:item[column.dataIndex])
                            }
